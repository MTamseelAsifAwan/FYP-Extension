...
import { FaTicketAlt, FaRobot, FaUsers, FaPaperPlane, FaCloud, FaShieldAlt, FaFlag, FaChartBar } from 'react-icons/fa';
...
const features = [
  {
    title: "Your Data",
    description: "Easily manage and access your data in one place.",
    icon: <FaCloud className="h-8 w-8 text-gradient-blue-orange-purple" />,
  },
  {
    title: "Secure",
    description: "Top-notch security features to protect your data.",
    icon: <FaShieldAlt className="h-8 w-8 text-gradient-blue-orange-purple" />,
  },
  {
    title: "Issue Tracking",
    description: "Easily track all the issues and workflows of your project.",
    icon: <FaFlag className="h-8 w-8 text-gradient-blue-orange-purple" />,
  },
  {
    title: "Reports and Analytics",
    description: "Get detailed reports and analytics of your project.",
    icon: <FaChartBar className="h-8 w-8 text-gradient-blue-orange-purple" />,
  },
];
...
const App = ({Homeref,Featuresref,Pricingref,Aboutusref}) => {
  ...
  return (
    <>
      <div className="popup-container mx-auto" style={{ backgroundImage: `url(${heroimage})`, backgroundSize: 'cover', backgroundPosition: 'center', height: '1000px', width: '1200px' }}>
      {/* <AnimatedBackground/> */}
      <div className=' pt-10 '>
      
      <div ref={Homeref} id='Home' className="bg-transparent font-serif justify-center grid grid-cols-1 items-center text-center flex-col px-4">
  <div className='float-in-right'>
    <div className="text-white rounded-2xl"> {/* Removed shadow and border classes */}
      ...
      <div  className='grid justify-center items-center grid-cols-1 grid-flow-col mt-10 '>
  ...
  ref={Featuresref}
  id="Feature"
  className="text-white font-serif text-center font-bold text-2xl"
>
  Features That meet your need
      ...
      {/* Feature Cards */}
      <div className="relative grid grid-cols-1 text-white sm:grid-cols-2 gap-4 p-4">
          {features.map((feature, index) => (
            <div key={index} className="shadow-boxy float-in-right rounded-xl p-4 bg-black backdrop-brightness-75 backdrop-filter backdrop-blur-lg ">
          ...
          <div
  id='features'
  className='grid grid-cols-2 md:grid-cols-2  px-10 gap-4'
>
  {/* Content Column */}
  ...
  <img
      ...
      className='w-60 h-auto rounded-lg'  // Make the image smaller
    />
  </div>
</div>
...
<div
                ...
                className=' float-in-left mt-1 p-4 ml-10 grid grid-flow-row justify-center text-center grid-rows-3'
              >
  <h1 className='text-white font-bold text-xl font-serif '>Ready to get started?</h1>
...
<div className="flex justify-center mt-2">
  <button ref={signbtnRef} className="hover:text-purple-900 relative bg-transparent text-white font-bold
             ...
             before:absolute before:inset-0 before:bg-gradient-to-r before:from-sky-400 before:via-purple-500 before:to-orange-500
             before:rounded-lg before:rounded-tr-[20px] before:rounded-tl-none
             before:z-[-1] before:p-[2px] w-24 text-danger_light font-sans">Sign in</button>
</div>
</div>
 ...
 <div
  ref={Aboutusref}
  id="About"
  className="mt-5 grid grid-cols-1 md:grid-cols-2 grid-flow-row rounded-2xl p-2 mb-10 ml-3 shadow-boxy text-white"
>
  {/* Text Content */}
  ...
  <div className="flex justify-center items-center">
    ...
    />
            ...
            <footer className='bg-black h-56 pt-3 w-full font-serif '>
  ...
  <motion.div
                ...
                className="down-to-up flex items-center gap-4 ml-4"
              >
      ...
      >
        ...
        >
          <path
            ...
            className="group-hover:fill-white fill-current duration-300"
          ></path>
          <path
